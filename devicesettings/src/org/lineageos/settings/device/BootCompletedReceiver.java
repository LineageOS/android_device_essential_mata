...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    private void setTouchscreenGripRejection(Context context) {
        ...
        boolean sens = prefs.getBoolean(Constants.GRIP_REJ_KEY, false);
        // TODO: Set grip rej on/off via property?
    }

    private void setTouchscreenSmoothness(Context context) {
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(context);
        int sens = prefs.getInt(Constants.SMOOTHNESS_KEY, 0);
        // TODO: Set smoothness via property?
    }
}
